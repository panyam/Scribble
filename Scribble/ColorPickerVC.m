...
#import <RSColorPickerView/RSOpacitySlider.h>

@interface ColorPickerVC() <RSColorPickerViewDelegate>
...
- (void)pushNext:(id)sender {
    ColorPickerVC *colorController = [[ColorPickerVC alloc] initWithNibName:nil bundle:nil];
